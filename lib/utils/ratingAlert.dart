...
int rating =1;
  RatingAlert(
      ...
      required this.user_rating, required this.ref})
      : super(key: key);
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          TextField(
            controller: header,
            decoration:  InputDecoration(labelText: AppLocalizations.of(context)!.titleReview),
          ),
          TextField(
            controller: review,
            decoration:  InputDecoration(labelText: AppLocalizations.of(context)!.giveReview),
          ),
          ...
          onPressed: () async {
            ...
            ProductRepository().addProductReview(body).then((value) async {
              ...
              if (value == AppString.success) {
                ...
                ref.refresh(productReviewProvider(pid));
