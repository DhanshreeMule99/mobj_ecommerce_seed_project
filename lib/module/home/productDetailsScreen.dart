...
class _ProductDetailsScreenState extends ConsumerState<ProductDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final ratingProduct = ref.watch(productReviewProvider(widget.uid));
  ...
  Widget buildContent(
      ...
      AsyncValue<List<ReviewProductModel>> ratingProduct,
                    ...
                    if ((selectedVariant != null &&
                      ...
                      ProductRepository()
                        ...
                        if (value == AppString.success) {
                          ...
                          ref.refresh(productDetailsProvider(widget.uid));
                          Fluttertoast.showToast(
                              msg: AppLocalizations.of(context)!.addToCartSuccess,
                              toastLength: Toast.LENGTH_SHORT,
                              gravity: ToastGravity.BOTTOM,
                              timeInSecForIosWeb: 0,
                    ...
                    ? Column(
                        ...
                        children: <Widget>[
                            ...
                            Row(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  Text(AppLocalizations.of(context)!.customerReview,
                                      style: TextStyle(
                                        fontSize: 0.05 *
                                            MediaQuery.of(context).size.width,
                                        fontWeight: FontWeight.w700,
                            ...
                            const SizedBox(height: 10),
                            for (int index = 0;
                                index < productlist.length && index < 1;
                                index++)
                              Column(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    ...
                                    productlist[index].body.toString() != ""
                                        ? Padding(
                                            padding: const EdgeInsets.only(
                            ...
                            if (productlist.length > 1)
                              Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Text(
                                      AppLocalizations.of(context)!.readMore.toUpperCase(),
                                      style: TextStyle(
                ...
                child: product.isNotEmpty
                    ? Column(
                        ...
                        children: <Widget>[
                            ...
                            Center(
                                child: Text(AppLocalizations.of(context)!.customerReview,
                                    style: TextStyle(
                                      fontSize: 0.05 *
                                          MediaQuery.of(context).size.width,
                                      fontWeight: FontWeight.w700,
