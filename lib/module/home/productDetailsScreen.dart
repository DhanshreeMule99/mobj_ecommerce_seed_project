    ...
    return appInfoAsyncValue.when(
        data: (appInfo) => Scaffold(
                                  ...
                                  if (value == true) {
                                    if ((selectedVariant != null &&
                                            selectedVariant.inventoryQuantity >
                                                0) ||
                                        user.variants[0].inventoryQuantity >
                                            0) {
                                        ...
                                        if ((variant.option1 !=
                                            ...
                                            (variant.option2 ==
                                                ...
                                                variant.option3 ==
                                                    DefaultValues
                                                        .defaultOption3)) {
                                          return ((variant.option1.contains(
            ...
            body: widget.uid == ""
                ...
                : user.when(
                    data: (user) {
                      return buildContent(context, user, ref, appInfoAsyncValue,
                          product, ratingProduct, productRating);
                    },
                  ...
                  children: [
                    ratingProduct.when(
                      data: (reviewsproduct) {
                        ...
                        List<int> ratings = reviewsproduct.reviews
                        ...
                        return InkWell(
                            ...
                            child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                      " (${averageRating.toStringAsFixed(1).toString()}/5)",
                                      style: Theme.of(context)
                                          .textTheme
                                          .headlineMedium),
                    ...
                    Wrap(
                      children:
                          productModel.options.asMap().entries.map((entry) {
                        return SizedBox(
                    ...
                    productModel.tags.toString() != ""
                        ? Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                  child:
                                      Text(" ${productModel.tags.toString()}")),
                            ],
                          )
                        : Container(),
                    productModel.tags.toString() != ""
                                          ...
                                          child: Center(
                                            ...
                                            child: Card(
                                              ...
                                              child: ProductListCard(
                                                ref: ref,
                                                stock: productlist.variants[0]
                                                            .available ==
                                                        true
                                                    ? 1
                                                    : 0,
                                                variantId: productlist
                                                    .variants[0].id
                                                    .toString(),
                                                shareProduct: () async {
