...
class _AddressScreenState extends ConsumerState<AddressScreen> {
  ...
  addOrUpdateAddress() async {
    ...
    if ((city.toLowerCase() == 'pune' && country.trim().toLowerCase() == 'india' && selectedAddressIndex==0) ||
        (countryController.text.trim().toLowerCase() == "india" &&
            cityController.text.trim().toLowerCase() == "pune"&& selectedAddressIndex==1)) {
      final body = {
        "address1":
      ...
      AddressRepository()
          .editAddress(
        body,
        widget.address != null ? widget.address!.id.toString() : "",
      )
          .then((value) async {
  ...
  Widget build(BuildContext context) {
    ...
    return appInfoAsyncValue.when(
        data: (appInfo) {
          return Scaffold(
            appBar: AppBar(
              title: Text(AppLocalizations.of(context)!.addressLabel.replaceAll(":", "")),
              elevation: 1,
            ),
                          ...
                          Wrap(
                            children: [
                              ...
                              ChoiceChip(
                                ...
                                label: Text(AppLocalizations.of(context)!.office,
                                    style: TextStyle(
                                        color:
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          TextFormField(
                                            ...
                                            decoration: buildInputDecoration(
                                                AppLocalizations.of(context)!.personNameLabel),
                                            validator: (value) {
                                              return Validation()
                                    ...
                                    Expanded(
                                      ...
                                      children: [
                                        ...
                                        TextFormField(
                                          ...
                                          keyboardType: TextInputType.phone,
                                          decoration: buildInputDecoration(
                                              AppLocalizations.of(context)!.zipLabel),
                                          validator: (value) {
                                            if (value!.isEmpty &&
                                                selectedAddressIndex == 1) {
                          ...
                          Padding(
                            ...
                            child: ElevatedButton(
                              ...
                              child: loader == false
                                  ? Text(
                                      widget.address != null
                                          ? AppLocalizations.of(context)!.updateAddressTitle
                                              .toUpperCase()
