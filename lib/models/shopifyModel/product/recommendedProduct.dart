...
class RecommendedProductModel {
  ...
  factory RecommendedProductModel.fromJson(Map<String, dynamic> json) {
    return RecommendedProductModel(
      ...
      description: json['description'] as String? ?? DefaultValues.stringDefault,
      publishedAt: json['published_at'] as String? ?? DefaultValues.stringDefault,
      ...
      tags: List<String>.from(json['tags'] as List? ?? DefaultValues.listStringDefault),
      price: (json['price'] as num? ?? DefaultValues.doubleDefault).toDouble(),
      priceMin: (json['price_min'] as num? ?? DefaultValues.doubleDefault).toDouble(),
      priceMax: (json['price_max'] as num? ?? DefaultValues.doubleDefault).toDouble(),
      ...
      variants: List<RecommendedProductVariant>.from(json['variants'].map((variant) => RecommendedProductVariant.fromJson(variant as Map<String, dynamic>))),
      images: List<String>.from(json['images'] as List? ?? DefaultValues.listStringDefault),
      featuredImage: json['featured_image'] as String? ?? DefaultValues.stringDefault,
      options: List<Map<String, dynamic>>.from(json['options'] as List? ?? DefaultValues.listMapDefault),
      url: json['url'] as String? ?? DefaultValues.stringDefault,
      media: List<Map<String, dynamic>>.from(json['media'] as List? ?? DefaultValues.listMapDefault),
    );
  }
}
...
class RecommendedProductVariant {
  ...
  factory RecommendedProductVariant.fromJson(Map<String, dynamic> json) {
    return RecommendedProductVariant(
      ...
      requiresShipping: json['requires_shipping'] as bool? ?? DefaultValues.boolDefault,
      taxable: json['taxable'] as bool? ?? DefaultValues.boolDefault,
      available: json['available'] as bool? ?? DefaultValues.boolDefault,
      name: json['name'] as String? ?? DefaultValues.stringDefault,
      publicTitle: json['public_title'] as String? ?? DefaultValues.stringDefault,
      options: List<String>.from(json['options'] as List? ?? DefaultValues.listStringDefault),
      price: (json['price'] as num? ?? DefaultValues.doubleDefault).toDouble(),
      weight: (json['weight'] as num? ?? DefaultValues.doubleDefault).toDouble(),
      inventoryManagement: json['inventory_management'] as String? ?? DefaultValues.stringDefault,
